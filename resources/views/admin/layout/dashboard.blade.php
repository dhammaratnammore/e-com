        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="categorylist" class="nav-item nav-link "><i class="fa fa-list me-2"></i>Catagory List</a>                   
                    <a href="{{ route('productlist') }}" class="nav-item nav-link"><i class="fa fa-list me-2"></i>Product List</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <a href="productform"><button  type="button" class="btn btn-primary m-2"><i class="fa fa-plus me-2"></i>Add Product</button></a>
